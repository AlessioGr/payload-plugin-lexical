...
const AtSignMentionsRegex = new RegExp(`${'(^|\\s|\\()(' + '['}${TRIGGERS}]` +
    `((?:${VALID_CHARS}${VALID_JOINS}){0,${LENGTH_LIMIT}})` +
    ')$');
// 50 is the longest alias length limit.
const ALIAS_LENGTH_LIMIT = 50;
// Regex used to match alias.
const AtSignMentionsRegexAliasRegex = new RegExp(`${'(^|\\s|\\()(' + '['}${TRIGGERS}]` +
...
class MentionTypeaheadOption extends LexicalTypeaheadMenuPlugin_1.TypeaheadOption {
