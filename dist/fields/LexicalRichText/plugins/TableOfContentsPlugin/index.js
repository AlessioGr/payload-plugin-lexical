...
const LexicalTableOfContents__EXPERIMENTAL_1 = __importDefault(require("@lexical/react/LexicalTableOfContents__EXPERIMENTAL"));
...
function TableOfContentsList({ tableOfContents, }) {
    ...
    return (React.createElement("div", { className: "table-of-contents" },
        React.createElement("ul", { className: "headings" }, tableOfContents.map(([key, text, tag], index) => {
            if (index === 0) {
                return (React.createElement("div", { className: "normal-heading-wrapper" },
                    React.createElement("div", { className: "first-heading", key: key, onClick: () => scrollToNode(key, index), role: "button", tabIndex: 0 }, (`${text}`).length > 20
                        ? `${text.substring(0, 20)}...`
                        : text),
                    React.createElement("br", null)));
            }
            return (React.createElement("div", { className: `normal-heading-wrapper ${selectedKey === key ? 'selected-heading-wrapper' : ''}` },
                React.createElement("div", { key: key, onClick: () => scrollToNode(key, index), role: "button", className: indent(tag), tabIndex: 0 },
...
function TableOfContentsPlugin() {
    return (React.createElement(LexicalTableOfContents__EXPERIMENTAL_1.default, null, (tableOfContents) => {
