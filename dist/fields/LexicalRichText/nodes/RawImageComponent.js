...
function RawImageComponent({ rawImagePayload, nodeKey, extraAttributes }) {
        ...
        function loadImageData() {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const relatedCollection = collections.find((coll) => {
                    console.log('coll.slug', coll.slug, 'insertImagePayload.relationTo', rawImagePayload.relationTo);
                ...
                const imagePayload = {
                    ...
                    height: extraAttributes && extraAttributes.heightOverride ? extraAttributes.heightOverride : json === null || json === void 0 ? void 0 : json.height,
                    maxWidth: extraAttributes && extraAttributes.widthOverride ? extraAttributes.widthOverride : json === null || json === void 0 ? void 0 : json.width,
