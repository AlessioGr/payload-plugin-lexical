...
function EquationEditor({ equation, setEquation, inline, inputRef, }) {
    ...
    return inline ? (React.createElement(InlineEquationEditor, Object.assign({}, props, { inputRef: inputRef }))) : (React.createElement(BlockEquationEditor, Object.assign({}, props, { inputRef: inputRef })));
}
