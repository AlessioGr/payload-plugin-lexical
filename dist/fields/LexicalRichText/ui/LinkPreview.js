...
function Glimmer(props) {
    return (React.createElement("div", Object.assign({ className: "LinkPreview__glimmer" }, props, { style: Object.assign({ animationDelay: String((props.index || 0) * 300) }, (props.style || {})) })));
}
